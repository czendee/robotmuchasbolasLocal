package com.tochi.RobotMuchasBolasRETRO.ChamanRV;
...
import com.tochi.RobotMuchasBolasRETRO.*;
...
*/ 
public class PubliperiscopioActivity extends CardboardActivity implements CardboardView.StereoRenderer, OnFrameAvailableListener {
...
private int floorLightPosParam;
      ...
      * @param  The resource ID of the raw text file about to be turned into a shader.
      * @return
      */
...
//         mVibrator = (Vibrator) getSystemService(Context.VIBRATOR_SERVICE);
 ...
 //
         ...
         mOverlayView.show3DToast("Information related to boxes and shipments may4:2016.");
//cz may 4, 2016    mOverlayView.showImage(0); //0 will display the image
         mOverlayView.showImage(1); //1 will display the image
//         mOverlayView.showIcon();//added cz may 4,2016 do not display icono
