 ...
 * the user.
 */
public class RequestTaskObtieneComandoRemotoTeledirigido extends AsyncTask<TextView, String, String> {
    TextView t;
    ...
    public String extraMessageUser=null;

    private ProgressDialog pd;

    public RequestTaskObtieneComandoRemotoTeledirigido(Context va) {
